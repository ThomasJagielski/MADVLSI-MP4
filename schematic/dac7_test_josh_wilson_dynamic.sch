...
N 1240 -690 1240 -660 { lab=Vbout}
N 1240 -690 1270 -690 { lab=Vbout}
N 1270 -730 1270 -690 { lab=Vbout}
...
N 1040 -400 1040 -330 { lab=Vod}
N 1040 -330 1040 -320 { lab=Vod}
...
N 1590 -10 1590 50 { lab=GND}
N 1750 -10 1750 50 { lab=GND}
N 1590 -100 1590 -70 { lab=#net29}
N 1670 -170 1720 -170 { lab=#net29}
N 1670 -170 1670 -100 { lab=#net29}
N 1590 -100 1670 -100 { lab=#net29}
N 1620 -170 1670 -170 { lab=#net29}
N 1590 -140 1590 -100 { lab=#net29}
...
C {madvlsi/nmos3.sym} 1270 -660 0 0 {name=M16
L=\{Lt\}
W=\{Wt\}
body=GND
nf=1
...
C {devices/lab_pin.sym} 1270 -690 2 0 {name=l5 sig_type=std_logic lab=Vbout}
...
C {devices/code_shown.sym} 1900 -250 0 0 {name=SPICE only_toplevel=false value=".param Wt = 3
.param Lt = 1
.control
tran 0.01u 420u
run
plot tran1.i(Vmeas) tran1.i(Vbias) tran1.i(VIbd) tran1.i(VIout)
plot tran1.i(Vib0) tran1.i(Vib1) tran1.i(Vib2) tran1.i(Vib3) tran1.i(Vib4) tran1.i(Vib5) tran1.i(Vib6)   
*plot tran1.v(b0) tran1.v(b1) tran1.v(b2) tran1.v(vbn) 
*plot tran1.v(Vdr1) tran1.v(Vdr2) tran1.v(Vdr3)
plot tran1.v(Vbn) tran1.v(Vb0) tran1.v(Vb1) tran1.v(Vb2) tran1.v(Vbd)
plot tran1.v(vdr6) tran1.v(vod) v(vgo)
