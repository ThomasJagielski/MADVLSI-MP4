...
N 1180 130 1180 150 { lab=Vgo}
N 1150 130 1150 180 { lab=Vgo}
N 1150 130 1180 130 { lab=Vgo}
N 1150 180 1290 180 { lab=Vgo}
N 1180 210 1180 220 { lab=#net8}
N 1080 220 1180 220 { lab=#net8}
N 1080 210 1080 220 { lab=#net8}
...
N -880 20 -880 50 { lab=#net9}
N -800 -50 -750 -50 { lab=#net9}
N -800 -50 -800 20 { lab=#net9}
N -880 20 -800 20 { lab=#net9}
N -850 -50 -800 -50 { lab=#net9}
N -880 -20 -880 20 { lab=#net9}
N -720 -20 -720 50 { lab=Vgt}
N -250 -200 -190 -200 { lab=Vb1}
N 1050 490 1050 510 { lab=Vg}
N 1130 -440 1270 -440 { lab=Vgt}
N 1180 110 1180 130 { lab=Vgo}
N 1130 -900 1130 -880 { lab=Vdr6}
N 1270 -910 1270 -880 { lab=#net10}
N 1270 -910 1430 -910 { lab=#net10}
N 1430 -910 1430 -880 { lab=#net10}
N 1200 -850 1240 -850 { lab=#net11}
N 1200 -850 1200 -800 { lab=#net11}
N 1130 -800 1200 -800 { lab=#net11}
N 1130 -820 1130 -800 { lab=#net11}
N 1270 -820 1270 -740 { lab=#net12}
N 1010 -900 1130 -900 { lab=Vdr6}
N 1130 -800 1130 -590 { lab=#net11}
N 1460 -850 1480 -850 { lab=#net13}
N 1480 -960 1480 -850 { lab=#net13}
N 1160 -960 1480 -960 { lab=#net13}
N 1480 -850 1480 -800 { lab=#net13}
N 1430 -800 1480 -800 { lab=#net13}
N 1270 -930 1270 -910 { lab=#net10}
N 1160 -850 1200 -850 { lab=#net11}
N 1130 -930 1130 -900 { lab=Vdr6}
N 1430 -820 1430 -800 { lab=#net13}
N 1130 -590 1190 -590 { lab=#net11}
N 1030 270 1050 270 { lab=#net6}
N 1190 -320 1190 -260 { lab=#net4}
N -610 340 -590 340 { lab=#net14}
N -490 360 -430 360 { lab=Vbn}
...
N 1050 20 1050 80 { lab=Vdr6}
N 1050 -40 1050 20 { lab=Vdr6}
...
N 800 -900 800 -390 { lab=Vdr6}
N 800 -900 1010 -900 { lab=Vdr6}
N 1190 -140 1320 -140 { lab=#net15}
N -340 290 -340 350 { lab=VDD}
N 1440 -440 1440 -380 { lab=Vgt}
N 1360 -350 1410 -350 { lab=#net5}
N 1470 -350 1530 -350 { lab=#net16}
N 1440 -440 1500 -440 { lab=Vgt}
N 1330 -440 1440 -440 { lab=Vgt}
N 1190 -590 1360 -590 { lab=#net11}
N 1530 -400 1530 -350 { lab=#net16}
N 1360 -400 1360 -350 { lab=#net5}
N 1190 -400 1190 -350 { lab=#net4}
N 1610 -440 1610 -380 { lab=Vgt}
N 1530 -350 1580 -350 { lab=#net16}
N 1640 -350 1700 -350 { lab=#net17}
N 1610 -440 1670 -440 { lab=Vgt}
N 1500 -440 1610 -440 { lab=Vgt}
N 1700 -400 1700 -350 { lab=#net17}
N 1530 -400 1530 -350 { lab=#net16}
N 1360 -590 1530 -590 { lab=#net11}
N 1480 -800 1480 -670 { lab=#net13}
N 1480 -670 1700 -670 { lab=#net13}
N 1780 -440 1780 -380 { lab=Vgt}
N 1700 -350 1750 -350 { lab=#net17}
N 1810 -350 1870 -350 { lab=#net18}
N 1780 -440 1840 -440 { lab=Vgt}
N 1670 -440 1780 -440 { lab=Vgt}
N 1870 -400 1870 -350 { lab=#net18}
N 1530 -590 1700 -590 { lab=#net11}
N 1700 -590 1700 -470 { lab=#net11}
N 1700 -670 1870 -670 { lab=#net13}
N 1870 -670 1870 -470 { lab=#net13}
...
C {madvlsi/ammeter1.sym} 800 -130 0 0 {name=VIb2}
...
C {madvlsi/ammeter1.sym} -340 410 0 0 {name=VIb3}
...
C {madvlsi/ammeter1.sym} 800 -260 0 0 {name=VIb6}
...
C {devices/lab_pin.sym} 1290 180 2 0 {name=l49 sig_type=std_logic lab=Vgo}
...
C {devices/code_shown.sym} 1400 50 0 0 {name=SPICE only_toplevel=false value=".param Wt = 3
.param Lt = 1
.control
tran 0.01u 300u
run
...
plot tran1.i(VIout1) tran1.i(VIout) tran1.i(VIout2) tran1.i(Vmeas)
...
C {madvlsi/resistor.sym} -620 370 0 0 {name=R1
value=100k
m=1}
C {madvlsi/gnd.sym} -620 400 0 0 {name=l8 lab=GND}
C {/home/madvlsi/Documents/MADVLSI-MP4/schematic/ibias.sym} -540 340 0 0 {name=X1}
C {madvlsi/ammeter1.sym} -610 340 1 1 {name=Vbias}
...
C {madvlsi/ammeter1.sym} 40 -130 0 0 {name=VIb7}
...
C {madvlsi/ammeter1.sym} 230 -130 0 0 {name=VIb9}
...
C {madvlsi/ammeter1.sym} 420 -130 0 0 {name=VIb11}
...
C {madvlsi/ammeter1.sym} 610 -130 0 0 {name=VIb13}
...
C {madvlsi/nmos3.sym} 1190 -170 0 0 {name=M26
L=\{Lt\}
W=\{Wt\}
body=GND
nf=1
...
C {devices/lab_pin.sym} 1160 -170 0 0 {name=l31 sig_type=std_logic lab=Vbn}
C {devices/lab_pin.sym} 1160 -230 0 0 {name=l32 sig_type=std_logic lab=Vbn}
C {madvlsi/nmos3.sym} 1320 -170 0 0 {name=M22
L=\{Lt\}
W=\{Wt\}
body=GND
nf=1
...
C {madvlsi/nmos3.sym} 1320 -230 0 0 {name=M29
L=\{Lt\}
W=\{Wt\}
body=GND
nf=1
...
C {devices/lab_pin.sym} 1290 -170 0 0 {name=l34 sig_type=std_logic lab=Vbn}
C {devices/lab_pin.sym} 1290 -230 0 0 {name=l35 sig_type=std_logic lab=Vbn}
C {madvlsi/gnd.sym} 1320 -260 2 0 {name=l56 lab=GND}
...
C {madvlsi/vdd.sym} 1190 -470 0 0 {name=l27 lab=VDD}
...
C {madvlsi/ammeter1.sym} 1700 -410 0 0 {name=VIb18}
C {madvlsi/vdd.sym} 1360 -470 0 0 {name=l37 lab=VDD}
C {madvlsi/nmos3.sym} 1780 -350 1 0 {name=M53
L=1
W=3
body=GND
nf=1
...
C {madvlsi/nmos3.sym} 1870 -440 0 0 {name=M54
L=1
W=3
body=GND
nf=1
...
C {madvlsi/ammeter1.sym} 1870 -410 0 0 {name=VIb19}
C {madvlsi/vdd.sym} 1530 -470 0 0 {name=l38 lab=VDD}
